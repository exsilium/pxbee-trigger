...
/**
	...
	@to_do move xbee_cmd_simple and xbee_identify into xbee_device layer?

	@to_do Add code to return an error (and disable the stack) if the XBee
			responds with an IEEE address not in Digi's allocation?

	@to_do review to_do list at the top of the file -- lots to do
...
*/
/*
	@to_do Figure out timeouts for this table.
...
/**
	...
	@to_do	add bounds checking on request to make sure it's in the table?
*/
_xbee_atcmd_debug
	...
	uint16_t length, void FAR *context)
{
	...
	// @to_do Only release if the appropriate flag is set (ignore response?)
